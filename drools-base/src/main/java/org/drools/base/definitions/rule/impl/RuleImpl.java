...
public class RuleImpl implements Externalizable,
    ...
    public boolean isMainAgendaGroup() {
        return "MAIN".equals( agendaGroup );
    }
    ...
    public boolean isEnabled(BaseTuple tuple,
                             Declaration[] declarations,
                             ValueResolver valueResolver) {
        return this.enabled.getValue( tuple, declarations, this, valueResolver );
    }
    ...
    public static class SafeEnabled implements Enabled, Serializable {
        ...
        public boolean getValue(final BaseTuple tuple,
                                ...
                                final RuleImpl rule,
                                final ValueResolver valueResolver) {
            return AccessController.doPrivileged((PrivilegedAction<Boolean>) () -> delegate.getValue(tuple, declarations, rule, valueResolver), KiePolicyHelper.getAccessContext());
        }

...
import org.kie.internal.builder.conf.MultiValueFlowBuilderOption;
import org.kie.internal.builder.conf.MultiValueRuleBuilderOption;
import org.kie.internal.conf.ConstraintJittingThresholdOption;

/**
 * A class for the accumulate function configuration.
 */
public class WorkDefinitionFunctionOption implements MultiValueFlowBuilderOption {
     ...
     * @param name
     */
    public WorkDefinitionFunctionOption(final String name, final Object function) {
        this.name = name;
     ...
     */
    public static WorkDefinitionFunctionOption get(final String name, final Object function) {
        return new WorkDefinitionFunctionOption(name, function );
    }
    ...
    public String toString() {
        return "WorkDefinition( name="+name+" function="+function+" )";
    }
    ...
    public boolean equals(Object obj) {
        ...
        WorkDefinitionFunctionOption other = (WorkDefinitionFunctionOption) obj;
        if ( function == null ) {

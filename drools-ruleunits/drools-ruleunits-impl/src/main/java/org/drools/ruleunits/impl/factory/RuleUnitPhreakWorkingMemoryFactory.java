...
public class RuleUnitPhreakWorkingMemoryFactory implements WorkingMemoryFactory, Serializable {
    ...
    private static final WorkingMemoryFactory INSTANCE = new RuleUnitPhreakWorkingMemoryFactory();
    ...
    public InternalWorkingMemory createWorkingMemory(long id, InternalKnowledgeBase kBase, FactHandleFactory handleFactory, long propagationContext, KieSessionConfiguration config, InternalAgenda agenda,
